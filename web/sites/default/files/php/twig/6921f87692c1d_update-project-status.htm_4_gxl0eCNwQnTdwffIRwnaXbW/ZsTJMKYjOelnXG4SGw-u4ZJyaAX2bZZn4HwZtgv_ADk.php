...
/* themes/contrib/gin/templates/admin/update-project-status.html.twig */
class __TwigTemplate_75176035a74cce5015f320a916445134 extends Template
{
...
($context["project"] ?? null), "status", [], "any", false, false, true, 32) == Twig\Extension\CoreExtension::constant("Drupal\\update\\UpdateManagerInterface::NOT_SECURE"))) ? ("project-update__status--security-error gin-status gin-status--danger") : ("")), (((CoreExtension::getAttribute($this->env, $this->source,         // line 33
($context["project"] ?? null), "status", [], "any", false, false, true, 33) == Twig\Extension\CoreExtension::constant("Drupal\\update\\UpdateManagerInterface::REVOKED"))) ? ("project-update__status--revoked gin-status gin-status--danger") : ("")), (((CoreExtension::getAttribute($this->env, $this->source,         // line 34
($context["project"] ?? null), "status", [], "any", false, false, true, 34) == Twig\Extension\CoreExtension::constant("Drupal\\update\\UpdateManagerInterface::NOT_SUPPORTED"))) ? ("project-update__status--not-supported gin-status gin-status--danger") : ("")), (((CoreExtension::getAttribute($this->env, $this->source,         // line 35
($context["project"] ?? null), "status", [], "any", false, false, true, 35) == Twig\Extension\CoreExtension::constant("Drupal\\update\\UpdateManagerInterface::NOT_CURRENT"))) ? ("project-update__status--not-current gin-status gin-status--warning") : ("")), (((CoreExtension::getAttribute($this->env, $this->source,         // line 36
($context["project"] ?? null), "status", [], "any", false, false, true, 36) == Twig\Extension\CoreExtension::constant("Drupal\\update\\UpdateManagerInterface::CURRENT"))) ? ("project-update__status--current gin-status gin-status--success") : (""))];
        // line 39
        yield "<div";
  ...
  <span class=\"gin-status-icon\">
    ";
        // line 41
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["status"] ?? null), "icon", [], "any", false, false, true, 41), "html", null, true);
        yield "
  </span>";
        // line 43
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["status"] ?? null), "label", [], "any", false, false, true, 43)) {
            // line 44
            yield "<span>";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["status"] ?? null), "label", [], "any", false, false, true, 44), "html", null, true);
            yield "</span>";
        } else {
            // line 46
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["status"] ?? null), "reason", [], "any", false, false, true, 46), "html", null, true);
        }
        // line 48
        yield "</div>
...
($context["project"] ?? null), "status", [], "any", false, false, true, 72) == Twig\Extension\CoreExtension::constant("Drupal\\update\\UpdateManagerInterface::NOT_SUPPORTED"))) ? ("project-not-supported") : (""))];
        // line 75
        yield "<div class=\"project-update__details\">
  ";
        // line 76
...
";
    ...
    {
        return "themes/contrib/gin/templates/admin/update-project-status.html.twig";
    }
    ...
    {
        return array (  199 => 106,  196 => 105,  194 => 103,  192 => 102,  187 => 99,  185 => 97,  183 => 96,  181 => 95,  177 => 93,  175 => 91,  174 => 90,  167 => 87,  164 => 86,  161 => 85,  157 => 83,  146 => 80,  141 => 79,  137 => 78,  134 => 77,  132 => 76,  129 => 75,  127 => 72,  126 => 71,  125 => 70,  124 => 69,  121 => 67,  111 => 64,  106 => 63,  104 => 62,  100 => 60,  94 => 58,  92 => 57,  87 => 56,  84 => 54,  77 => 52,  75 => 51,  71 => 48,  68 => 46,  63 => 44,  61 => 43,  57 => 41,  51 => 39,  49 => 36,  48 => 35,  47 => 34,  46 => 33,  45 => 32,  44 => 31,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "themes/contrib/gin/templates/admin/update-project-status.html.twig", "/var/www/html/web/themes/contrib/gin/templates/admin/update-project-status.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = ["set" => 31, "if" => 43, "for" => 63, "trans" => 90];

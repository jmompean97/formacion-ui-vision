 ...
 */
class ExtraFieldPluginPlusExampleNodeLabelFunctionalJavascriptTest extends WebDriverTestBase {
  ...
  public function testSetFieldSettingsViaUi() {
    ...
    $display_repository->getViewDisplay('node', 'article')
      ->setComponent('extra_field_example_node_label', [
    ...
    $page->pressButton('edit-fields-extra-field-example-node-label-settings-edit');
    $session->waitForElementVisible('css', 'input[id*="edit-fields-extra-field-example-node-label-settings-edit-form-actions-save-settings"]');
    $this->submitForm([
      'fields[extra_field_example_node_label][settings_edit_form][settings][link_to_entity]' => FALSE,
      'fields[extra_field_example_node_label][settings_edit_form][settings][wrapper]' => 'p',
    ], 'Update');
    $session->waitForElementRemoved('css', 'input[id*="edit-fields-extra-field-example-node-label-settings-edit-form-actions-save-settings"]');
  ...
  /**
   * Tests the field with no link and span settings.
   */
  ...
  public function testSettingsSummary() {
    ...
    $session->waitForElementVisible('css', 'input[id*="edit-fields-extra-field-example-node-label-settings-edit-form-actions-save-settings"]');
    $this->submitForm([
      'fields[extra_field_example_node_label][settings_edit_form][settings][link_to_entity]' => TRUE,
      'fields[extra_field_example_node_label][settings_edit_form][settings][wrapper]' => 'p',
    ], 'Update');
    $session->waitForElementRemoved('css', 'input[id*="edit-fields-extra-field-example-node-label-settings-edit-form-actions-save-settings"]');
  ...
  public function fieldShowsUpInLayoutBuilder() {
    ...
    $session->pageTextContainsOnce('Placeholder for the "Extra Field Plus: Example Node Label" field');
  }
  ...
  public function testFieldInLayoutBuilder() {
    ...
    $session->pageTextContains('Example Node Label');
    $this->drupalGet('/layout_builder/add/block/defaults/node.article.default/0/content/extra_field_block%3Anode%3Aarticle%3Aextra_field_example_node_label');
